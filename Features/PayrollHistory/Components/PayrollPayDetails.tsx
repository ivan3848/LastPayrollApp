...
import payrollPayDetailService, {
    payrollPayDetailNotPaidService,
} from "../Services/payrollPayDetailService";
    ...
    return (
        ...
        >
            ...
            <div className="card">
                ...
                >
                    <TabPanel header="Nómina Liquidada">
                        <PayrollPayDetailTable entity={data.items} />
                    </TabPanel>
                    <TabPanel header="Nómina Con Saldo Cero">
