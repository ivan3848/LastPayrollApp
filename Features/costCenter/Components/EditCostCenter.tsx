...
const EditCostCenter = ({
    ...
    const { editEntityFormSchema } = costCenterFormSchemas();
    ...
    const editEntity = useEditCostCenterQuery({
        toast,
        setEditEntityDialog,
        setSubmitted,
        reset,
    ...
    const onSubmit = (data: ICostCenter) => {
        data.idCostCenter = entity.idCostCenter;
