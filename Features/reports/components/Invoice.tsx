                    ...
                    <Page key={index} style={styles.body}>
                        <View style={[styles.table]}>
                            ...
                            >
                                ...
                                >
                                    Desde {formatDate(payrollPeriodStart)} Hasta{" "}
                            ...
                            {creditIsrSustracted && (
                                <>
                                    <View style={styles.tableRow}>
                                        ...
                                        >
                                            {creditIsrSustracted?.toLocaleString(
                                                "es-DO",
                                                {
                                                    style: "currency",
                                                    currency: "DOP",
                                        ...
                                        >
                                            {creditIsrRemain?.toLocaleString(
                                                "es-DO",
                                                {
                                                    style: "currency",
                                                    currency: "DOP",
                            ...
                            <View style={[styles.tableRow, styles.addTopline]}>
                                ...
                                >
                                    {totalProfit?.toLocaleString("es-DO", {
                                        style: "currency",
                                        currency: "DOP",
                                    }) || "N/A"}
                                </Text>
                                ...
                                >
                                    {totalDeduction?.toLocaleString("es-DO", {
                                        style: "currency",
                                        currency: "DOP",
                                    }) || "N/A"}
                                </Text>
