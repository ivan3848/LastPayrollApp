...
interface Props {
    submitted: boolean;
    handleAdd: () => void;
    handleEdit: (entity: IToolWorkDefinition) => void;
    handleDelete: (entity: IToolWorkDefinition) => void;
}

const ToolWorkDefinitionTable = ({
    submitted,
    handleDelete,
    handleEdit,
    handleAdd,
    ...
    return (
        <DataTable
            id="ToolWorkDefinition-Table"
            dataKey="idToolWorkDefinition"
            value={data?.items}
            lazy
            paginator
            loading={isLoading}
        ...
        >
            ...
            <Column
                header="Acciones"
                body={(rowData) => (
                    <ActionTableTemplate<IToolWorkDefinition>
                        entity={rowData}
...
export default ToolWorkDefinitionTable;
